...
VL_ATTR_COLD void Vtbench___024root___ctor_var_reset(Vtbench___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 1024; ++__Vi0) {
        vlSelf->tbench__DOT__dut__DOT__brpc__DOT__predictor__DOT__counter[__Vi0] = VL_RAND_RESET_I(2);
    }
    ...
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v0 = VL_RAND_RESET_I(16);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v0 = VL_RAND_RESET_I(4);
    vlSelf->__VdlySet__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v0 = 0;
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v1 = VL_RAND_RESET_I(16);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v1 = VL_RAND_RESET_I(4);
    vlSelf->__VdlySet__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v1 = 0;
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v2 = VL_RAND_RESET_I(8);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v2 = VL_RAND_RESET_I(4);
    vlSelf->__VdlySet__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v2 = 0;
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v3 = VL_RAND_RESET_I(8);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v3 = VL_RAND_RESET_I(4);
    vlSelf->__VdlySet__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v3 = 0;
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v4 = VL_RAND_RESET_I(8);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v4 = VL_RAND_RESET_I(4);
    vlSelf->__VdlySet__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v4 = 0;
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v5 = VL_RAND_RESET_I(8);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v5 = VL_RAND_RESET_I(4);
    vlSelf->__VdlySet__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v5 = 0;
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v6 = VL_RAND_RESET_I(32);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v6 = VL_RAND_RESET_I(4);
    vlSelf->__VdlySet__tbench__DOT__dut__DOT__LS__DOT__io_buffer__v6 = 0;
