...
VL_ATTR_COLD void Vtbench___024root___eval_initial__TOP(Vtbench___024root* vlSelf) {
    ...
    vlSelfRef.tbench__DOT__dut__DOT__wb_rd_wren = 1U;
...
VL_ATTR_COLD void Vtbench___024root___stl_comb__TOP__0(Vtbench___024root* vlSelf);
...
VL_ATTR_COLD void Vtbench___024root___eval_stl(Vtbench___024root* vlSelf) {
    ...
    if ((5ULL & vlSelfRef.__VstlTriggered.word(0U))) {
        Vtbench___024root___stl_comb__TOP__0(vlSelf);
    }
...
VL_ATTR_COLD void Vtbench___024root___stl_comb__TOP__0(Vtbench___024root* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtbench___024root___stl_comb__TOP__0\n"); );
    Vtbench__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
...
VL_ATTR_COLD void Vtbench___024root___ctor_var_reset(Vtbench___024root* vlSelf) {
    ...
    vlSelf->tbench__DOT__dut__DOT__id_ex_flush = VL_RAND_RESET_I(1);
    ...
    vlSelf->tbench__DOT__dut__DOT__id_I_type = VL_RAND_RESET_I(1);
    vlSelf->tbench__DOT__dut__DOT____VdfgRegularize_hf6e9fc58_2_0 = VL_RAND_RESET_I(1);
    vlSelf->tbench__DOT__dut__DOT____VdfgRegularize_hf6e9fc58_2_1 = VL_RAND_RESET_I(1);
    vlSelf->tbench__DOT__dut__DOT____VdfgRegularize_hf6e9fc58_2_2 = VL_RAND_RESET_I(1);
