...
VL_INLINE_OPT void Vtbench___024root___act_sequent__TOP__2(Vtbench___024root* vlSelf) {
    ...
    vlSelfRef.tbench__DOT__dut__DOT__BRC__DOT__branchcompare__DOT__lt_temp 
        = __Vtemp_1;
    __Vtableidx2 = (((IData)((0xffffffffU == (~ vlSelfRef.tbench__DOT__dut__DOT__BRC__DOT__branchcompare__DOT__A_xor_B))) 
...
VL_INLINE_OPT void Vtbench___024root___nba_sequent__TOP__0(Vtbench___024root* vlSelf) {
    ...
    __Vtableidx1 = ((((IData)(vlSelfRef.tbench__DOT__dut__DOT__ex_br_jmp) 
                      << 4U) | ((IData)(vlSelfRef.tbench__DOT__dut__DOT__brpc__DOT__predictor__DOT__counter) 
                                << 2U)) | (((IData)(vlSelfRef.tbench__DOT__dut__DOT__ex_branch_cmd) 
                                            << 1U) 
                                           | (IData)(vlSelfRef.tbench__DOT__i_reset)));
    if (Vtbench__ConstPool__TABLE_h57cf5229_0[__Vtableidx1]) {
        vlSelfRef.tbench__DOT__dut__DOT__brpc__DOT__predictor__DOT__counter 
            = Vtbench__ConstPool__TABLE_h3f194c3e_0
            [__Vtableidx1];
    }
                               ...
                               >> 2U))) || ((0x18U 
                                             == (0x1fU 
                                                 & (vlSelfRef.tbench__DOT__dut__DOT__if_instr 
                                                    >> 2U))) 
                                            && (1U 
                                                & ((IData)(vlSelfRef.tbench__DOT__dut__DOT__brpc__DOT__predictor__DOT__counter) 
                                                   >> 1U))));
    vlSelfRef.tbench__DOT__dut__DOT__if_branch_pc = 
        ((0x1bU == (0x1fU & (vlSelfRef.tbench__DOT__dut__DOT__if_instr 
