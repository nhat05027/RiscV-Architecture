...
VL_ATTR_COLD void Vtbench___024root___dump_triggers__act(Vtbench___024root* vlSelf) {
    ...
    if ((0x80ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 7 is active: @( tbench.dut.DP.pc)\n");
    }
    if ((0x100ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 8 is active: @(negedge tbench.i_clk)\n");
    }
...
VL_ATTR_COLD void Vtbench___024root___dump_triggers__nba(Vtbench___024root* vlSelf) {
    ...
    if ((0x80ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 7 is active: @( tbench.dut.DP.pc)\n");
    }
    if ((0x100ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 8 is active: @(negedge tbench.i_clk)\n");
    }
...
VL_ATTR_COLD void Vtbench___024root___ctor_var_reset(Vtbench___024root* vlSelf) {
    ...
    vlSelf->tbench__DOT__o_io_ledr = VL_RAND_RESET_I(32);
    vlSelf->tbench__DOT__o_io_ledg = VL_RAND_RESET_I(32);
    vlSelf->tbench__DOT__o_io_hex0 = VL_RAND_RESET_I(7);
    vlSelf->tbench__DOT__o_io_hex1 = VL_RAND_RESET_I(7);
    vlSelf->tbench__DOT__o_io_hex2 = VL_RAND_RESET_I(7);
    vlSelf->tbench__DOT__o_io_hex3 = VL_RAND_RESET_I(7);
    vlSelf->tbench__DOT__o_io_hex4 = VL_RAND_RESET_I(7);
    vlSelf->tbench__DOT__o_io_hex5 = VL_RAND_RESET_I(7);
    vlSelf->tbench__DOT__o_io_hex6 = VL_RAND_RESET_I(7);
    vlSelf->tbench__DOT__o_io_hex7 = VL_RAND_RESET_I(7);
    vlSelf->tbench__DOT__o_io_lcd = VL_RAND_RESET_I(32);
    ...
    vlSelf->tbench__DOT__dut__DOT__DP__DOT__rs2_data = VL_RAND_RESET_I(32);
    ...
    for (int __Vi0 = 0; __Vi0 < 4096; ++__Vi0) {
        vlSelf->tbench__DOT__dut__DOT__DP__DOT__IM__DOT__i_mem[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->tbench__DOT__dut__DOT__DP__DOT__IM__DOT__pc_addr = VL_RAND_RESET_I(12);
    ...
    vlSelf->tbench__DOT__dut__DOT__DP__DOT__RF__DOT__pre_rd_wren = VL_RAND_RESET_I(1);
    ...
    vlSelf->tbench__DOT__dut__DOT__DP__DOT__LS__DOT____Vxrand_h8df6f50b__7 = VL_RAND_RESET_I(1);
    vlSelf->tbench__DOT__dut__DOT__DP__DOT__LS__DOT____Vxrand_h8df6f50b__6 = VL_RAND_RESET_I(1);
    vlSelf->tbench__DOT__dut__DOT__DP__DOT__LS__DOT____Vxrand_h8df6f50b__5 = VL_RAND_RESET_I(1);
    vlSelf->tbench__DOT__dut__DOT__DP__DOT__LS__DOT____Vxrand_h8df6f50b__4 = VL_RAND_RESET_I(1);
    vlSelf->tbench__DOT__dut__DOT__DP__DOT__LS__DOT____Vxrand_h8df6f50b__3 = VL_RAND_RESET_I(1);
    vlSelf->tbench__DOT__dut__DOT__DP__DOT__LS__DOT____Vxrand_h8df6f50b__2 = VL_RAND_RESET_I(1);
    vlSelf->tbench__DOT__dut__DOT__DP__DOT__LS__DOT____Vxrand_h8df6f50b__1 = VL_RAND_RESET_I(1);
    vlSelf->tbench__DOT__dut__DOT__DP__DOT__LS__DOT____Vxrand_h8df6f50b__0 = VL_RAND_RESET_I(1);
    for (int __Vi0 = 0; __Vi0 < 1024; ++__Vi0) {
        vlSelf->tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem[__Vi0] = VL_RAND_RESET_I(8);
    }
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v0 = VL_RAND_RESET_I(8);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v0 = VL_RAND_RESET_I(10);
    vlSelf->__VdlySet__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v0 = 0;
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v1 = VL_RAND_RESET_I(8);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v1 = VL_RAND_RESET_I(10);
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v2 = VL_RAND_RESET_I(8);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v2 = VL_RAND_RESET_I(10);
    ...
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v3 = VL_RAND_RESET_I(10);
    ...
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v4 = VL_RAND_RESET_I(10);
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v5 = VL_RAND_RESET_I(8);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v5 = VL_RAND_RESET_I(10);
    vlSelf->__VdlyVal__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v6 = VL_RAND_RESET_I(8);
    vlSelf->__VdlyDim0__tbench__DOT__dut__DOT__DP__DOT__LS__DOT__d_mem__v6 = VL_RAND_RESET_I(10);
